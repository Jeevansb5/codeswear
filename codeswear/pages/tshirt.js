          ...
          <div className="container px-5 py-24 mx-auto">
            <div className="flex flex-wrap m-4 md:mx-20 justify-center">
              {Object.keys(products).map((item) => {
                return <div key={products[item]._id} className="lg:w-1/5 md:w-1/2 p-4 w-full shadow-md m-5">
                  ...
                  <Link href={`/product/${products[item].slug}`}> <div className="mt-4 text-center md:text-left">
                    ...
                    <div className='my-1'>
                      ...
                      {products[item].color.includes('green') && <button className="border-2 border-gray-300 ml-1 bg-green-800 rounded-full w-6 h-6 focus:outline-none"></button>}
  ...
  for (let item of products) {
    if (item.title in tshirts) {
      ...
      if (item.availableQty > 0) {
        ...
        tshirts[item.title].color = [0]
        tshirts[item.title].size = [0]
      }
    }
